...
xarpes.Constant(offset=900),
xarpes.SpectralQuadratic(amplitude=20, peak=7.5, broadening=0.009,
...
self_energy = xarpes.SelfEnergy(*mdcs.expose_parameters(select_label='Right_branch_1', 
                                bare_mass=-2, fermi_wavevector=0.37, side='right'))
