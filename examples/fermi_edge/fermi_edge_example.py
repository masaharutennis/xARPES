...
fdir = xarpes.fermi_dirac(mu=31.7, temperature=20, background=100, integrated_weight=1000, \
...
fig = bmap.fit_fermi_edge(mu_guess=32, background_guess=1e5, integrated_weight_guess=1.5e6, \
